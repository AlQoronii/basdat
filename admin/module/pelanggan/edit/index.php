<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-mf-4">
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="recipient-nama" class="col-form-label">Jabatan:</label>
                                    <select class="form-select" name="jabatan" name aria-label="Default select example">
                                        ...
                                        ?>
                                            <option value="<?= $row['id'] ;?>" <?= ($row['jabatan_id'] == $row['id']) ? 'selected' : '' ?>><?= $row['jabatan']; ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
